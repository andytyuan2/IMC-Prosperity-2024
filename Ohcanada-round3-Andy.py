...
empty_dict = {'AMETHYSTS' : 0, 'STARFRUIT' : 0, 'ORCHIDS': 0, 'GIFT_BASKET': 0, 'ROSES': 0, 'STRAWBERRIES': 0, 'CHOCOLATE': 0}
...
# Compute conditional regression on orchids - Sunlight, humidity
 ...
 # compute orders for basket  
    def compute_orders_basket(self, order_depth):
        ...
        res_buy = mid_price['GIFT_BASKET'] - mid_price['STRAWBERRIES']*4 - mid_price['CHOCOLATE']*2 - mid_price['ROSES'] - 375
        res_sell = mid_price['GIFT_BASKET'] - mid_price['STRAWBERRIES']*4 - mid_price['CHOCOLATE']*2 - mid_price['ROSES'] - 375
 ...
 # RUN function, Only method required. It takes all buy and sell orders for all symbols as an input, and outputs a list of orders to be sent
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        result = {'AMETHYSTS' : [], 'STARFRUIT' : [], 'ORCHIDS' : [], 'CHOCOLATE': [], 'GIFT_BASKET': [], 'ROSES': [], 'STRAWBERRIES': []}
